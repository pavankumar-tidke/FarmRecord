...
const Index = () => {
  ...
  const handleDelete = async (pk, content) => {
    try {
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/dw/`, { pk, content });
      // setLoading(false);
      console.log(response);
      if (response.data.success) {
        const cardToRemove = document.getElementById(`${(content === 'view') ? 'work' : (content === 'prodview') ? 'prod' : null}-card-${pk}`);
  ...
  const editFormSubmit = async (event, content) => {
    ...
    const newData = (content === 'edit' ? {
      'content': content, 'pk': pk, 'workHeading': event.target.work_heading.value, 'workDescription': event.target.work_desc.value, 'workAmount': event.target.work_amount.value, 'workLocation': event.target.work_location.value, 'addedAt': event.target.added_at.value, 'editedAt': editedAt, 
    } : (content === 'prodedit') ? {
      'content': content, 'pk': pk, 'cropName': selectedCrop, 'cropDesc': event.target.crop_desc.value, 'cropWeight': `${event.target.weight_qntl.value} क्विंटल, ${event.target.weight_kg.value} किलो`, 'cropAmount': event.target.crop_amount.value, 'cropLocation': event.target.sell_location.value, 'addedAt': event.target.added_at.value, 'editedAt': editedAt,
    } : null)

    try {
      console.log(drawerData);
      const response = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/ew/`, newData );
                    ...
                    <div className="rounded-2xl p-1 duration-300 drop-shadow-lg ">    
                      ...
                      <div className="space-y-3 text-white mt-16">
                        {data.length === 0 ? (
                          ...
                          <div className="space-y-4 overflow-y-auto " id="work-card-div">
                    ...
                    <div  className="rounded-2xl p-1  duration-300 drop-shadow-lg">   
                        <div className="space-y-3 text-white mt-16">
                          {data.length === 0 ? (
                            ...
                            <div className="space-y-4 overflow-y-auto " id="prod-card-div">
          ...
          <div>
            ...
            (
              ...
              >
                ...
                <div className="w-full space-y-4">
                  <div className="flex justify-between">
                    <div className="">
                      <h5 className="text-lg font-medium text-slate-950 dark:text-white">Crop Name</h5>
                      <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{drawerData.fields.crop_name}</h5>
                    </div>
                  </div>
                  <div className="">
                    <h5 className="text-lg font-medium text-slate-950 dark:text-white">Sell Discription</h5>
                    <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{drawerData.fields.crop_desc}</h5>
                  </div>
                  <div className="">
                    <h5 className="text-lg font-medium text-slate-950 dark:text-white">Crop Weight</h5>
                    <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{drawerData.fields.crop_weight}</h5>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="">
                      <h5 className="text-lg font-medium text-slate-950 dark:text-white"> Location</h5>
                      <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{drawerData.fields.sell_location}</h5>
                    </div>
                    <div className="">
                      <h5 className="text-lg font-medium text-slate-950 dark:text-white">Total Selling Price</h5>
                      <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">
                        <span className="material-symbols-outlined small-icon align-middle text-slate-800 dark:text-slate-300">currency_rupee</span>
                  ...
                  <div className="">
                    <h5 className="text-lg font-medium text-slate-950 dark:text-white">Sell Date</h5>
                    <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{formattedDateTime(drawerData.fields.added_at)}</h5>
                  </div>
                  <div className="">
                    <h5 className="text-lg font-medium text-slate-950 dark:text-white">Info Edited On</h5>
                    <h5 className="text-base font-normal text-slate-800 dark:text-slate-300">{(drawerData.fields.edited_at === '-' ? '-' : formattedDateTime(drawerData.fields.edited_at))}</h5>
                  </div>
                </div>
            ...
            (
              <BottomDrawer
                ...
                height={800}
              >
                <form onSubmit={(event) => editFormSubmit(event, 'prodedit')} className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-1 gap-2  rounded-lg p-2 w-full "> 
                    <div className="w-full">
                        <label htmlFor="small" className="block text-sm mb-2 font-medium text-gray-900 dark:text-white">Select Crop</label>
                        <select onChange={handleCropChange} defaultValue={selectedCrop} id="small" className="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div className="w-full">
                        ...
                        <textarea defaultValue={drawerData.fields.crop_desc} id="crop_desc" rows="4" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg   block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Latur Buyer Name"  required></textarea>
                    </div> 
                    <div className="w-full">
                        ...
                        <input defaultValue={drawerData.fields.sell_location} type="text" id="sell_location" name="sell_location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Latur, Ghatnandur"  />
                    </div>
                    <div className="flex gap-2 w-full">
                        <div className="w-full relative">
                            ...
                            <input
                                defaultValue={drawerData.fields.crop_weight.match(/\d+/g).map(Number)[0]}
                                type="number"
                                id="weight_qntl"
                                name="weight_qntl"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div className="w-full relative">
                            ...
                            <input
                                defaultValue={drawerData.fields.crop_weight.match(/\d+/g).map(Number)[1]}
                                type="number"
                                id="weight_kg"
                                name="weight_kg"
                                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    ...
                    <div className="w-full">
                        ...
                        <input defaultValue={drawerData.fields.crop_amount} type="number" id="crop_amount" name="crop_amount" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="₹ 2,230 /-" required />
                    </div>    
                    <div className="w-full">
                      <label
                        htmlFor="work_location"
